...
- **Agents propose, humans decide.** The agent reads SigNoz and proposes a reroute; the change is a diff in `toy-world/routing.json` that a human approves. Nothing applies itself.
